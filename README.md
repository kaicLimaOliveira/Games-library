...
## 💻 Projeto
Esse projeto consiste em um CRUD com VueJs, Typescript e a lib BootsWatch do Bootstrap. Incluir, alterar e excluir as informações de uma lista de jogos.
...
```bash
  git clone https://github.com/kaicLimaOliveira/Games-library.git
```
